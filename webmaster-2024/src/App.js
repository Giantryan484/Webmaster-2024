    ...
    <div className='app-container' style={{
      ...
      <header className="header-bar">
              <div className="button-group left">
                  <button onClick={() => handleZoom(49, 2, "0vw 55vw")} className="header-button">Flashcards</button>
                  <button onClick={() => handleZoom(79, 2, "100vw 82vw")} className="header-button">Home Explorer</button>
              </div>
              <div className="button-group right">
                  <button onClick={() => handleZoom(105, 2, "0vw 105vw")} className="header-button">Slideshow</button>
        ...
        {zoomedIn === false && (
          <>
          <button className='big-button top-left-button' onClick={() => handleZoom(49, 2, "0vw 55vw")}></button>
          <button className='big-button middle-right-button' onClick={() => handleZoom(79, 2, "100vw 82vw")}></button>
          <button className='big-button bottom-left-button' onClick={() => handleZoom(105, 2, "0vw 105vw")}></button>
          </>
